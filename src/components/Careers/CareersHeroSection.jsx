    ...
    <div className="hero-container">
      ...
      >
        ...
        <Box sx={{ position: "absolute", bottom: -5 }}>
          <img src={IMG_jumping2} alt="jumping_floor" />
        </Box>
        ...
        <Grid
          container
          sx={{ position: "absolute", bottom: "5vh", height: "auto", zIndex: 4, paddingLeft: "5%"}}
        >
          <Grid item xs={10}>
            <Box sx={{ display: "flex" }}>
              ...
              />
              <Typography variant="h2" sx={{ fontSize: { xs: 25, md: 30, lg:50 }, color: h1_color }}>
                Why work with us
              </Typography>
            </Box>
          </Grid>
